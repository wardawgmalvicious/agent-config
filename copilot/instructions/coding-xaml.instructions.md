---
name: 'XAML App Conventions'
description: 'XAML conventions for WinUI, UWP, WPF and MAUI markup, code-behind and view models: binding, resources, threading, MVVM Toolkit'
applyTo: '**/*.xaml,**/*.xaml.cs,**/*ViewModel.cs'
---
...
model named anything else is not matched.
...
- **A page is constructed by the framework, not the container.**
  ...
  service-locator call the C# instructions allow. Pass per-navigation data
