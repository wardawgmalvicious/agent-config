---
name: 'Pipeline Expression Conventions'
description: 'Expression conventions for Fabric data pipelines (pipeline-content.json)'
applyTo: '**/*.DataPipeline/pipeline-content.json,**/pipeline/*.json'
---
...
- Fabric pipeline expressions (auto-applies via `applyTo` above)
