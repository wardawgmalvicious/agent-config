---
name: 'TMDL Conventions'
description: 'TMDL conventions for Fabric semantic models, Power BI Project (PBIP) format and Tabular Editor output'
applyTo: '**/*.tmdl,**/definition/**/model.bim'
---
