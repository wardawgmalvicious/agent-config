---
name: 'KQL Conventions'
description: 'Kusto Query Language conventions for Azure Data Explorer, Log Analytics, Sentinel, Defender XDR and Fabric Real-Time Intelligence'
applyTo: '**/*.kql,**/*.csl,**/*.KQLQueryset/RealTimeQueryset.json,**/*.KQLDatabase/EmbeddedRealTimeQueryset.json,**/*.KQLDashboard/RealTimeDashboard.json'
---
