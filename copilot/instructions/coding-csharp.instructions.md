---
name: 'C# Conventions'
description: 'C# conventions for .NET libraries, services and desktop apps: nullability, async, DI lifetime, Azure SDK, data access and JSON'
applyTo: '**/*.cs,**/*.csproj'
---
...
- **Constructor injection.** Resolving from the container inside a class
  ...
  framework constructs itself — see the XAML instructions for XAML pages.
